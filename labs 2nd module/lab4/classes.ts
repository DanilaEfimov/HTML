...
export namespace transport {
    ...
    export interface Auto extends Vehicle {
        getType() : type;
        getBodywork() : bodywork;
    }

    export class SportCar implements Auto {
        private Type : type;
    ...
    export class SportBike implements Bike{
        private make: string;
        private model: string;
        private year: number;
        private vin: string;
...
class Garage<T extends transport.Vehicle> implements transport.VehicleStorage<T> {
    creationDate: Date;
    vehicles: T[];
